...
$('.intro-articles').readmore({speed: 500});
...
;(function($) {
 ...
 // sidebar contact icon toggleClass
 function toggle() {
    $(".ico01").click(function () {
    $(".sidebar-contacts").toggleClass("active");
    });
  }
  toggle();
...
$(document).ready(function() {
	$('.rounded-accordion .collapse').on('shown.bs.collapse', function () {
		$(this).prev().addClass('active-acc');
	});

	$('.rounded-accordion .collapse').on('hidden.bs.collapse', function () {
...
$(document).ready(function(){
			...
			$(".line-accordion .collapse.show").each(function(){
				$(this).prev(".card-header").find(".fa").addClass("fa-minus").removeClass("fa-plus");
			});
			
			// Toggle plus minus icon on show hide of collapse element
			$(".line-accordion .collapse").on('show.bs.collapse', function(){
...
$(document).ready(function(){
			// Add minus icon for collapse element which is open by default
			$(".faq-accordion .collapse.show").each(function(){
				$(this).prev(".card-header").find(".fa").addClass("fa-minus").removeClass("fa-plus");
			});
...
// benefit sync carousel
$(document).ready(function(){
			
			$('.benfit-carousel').owlCarousel({
				margin: 10,
				nav: true,
				dots:false,
