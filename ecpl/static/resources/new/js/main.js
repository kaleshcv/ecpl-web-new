...
var responsiveMenu = function() {
        ...
        $(window).on('load resize', function() {
            ...
            if ( currMenuType !== menuType ) {
                ...
                if ( currMenuType === 'mobile' ) {
                    var $mobileMenu = $('#mainnav_1').attr('id', 'mainnav-mobi').hide();
                    var hasChildMenu = $('#mainnav-mobi').find('li:has(ul)');
                    ...
                    var $desktopMenu = $('#mainnav-mobi').attr('id', 'mainnav_1').removeAttr('style');
    ...
    var retinaLogos = function() {
      var retina = window.devicePixelRatio > 1 ? true : false;
        if(retina) {
            $('.header .logo').find('img').attr({src:'/images/expertcallers-logo.png'});   
        }

        if(retina) {
            $('.footer .logo').find('img').attr({src:'/images/expertcallers-logo.png'});   
        }
    };    
